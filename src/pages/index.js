              ...
              >
                <li className="w-[320px] h-[280px] relative">
                  ...
                  <svg
                    ...
                    className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-c_gray_1/60 scale-95 rounded-full p-2 group-hover/episode:scale-105 transition-all"
                  >
